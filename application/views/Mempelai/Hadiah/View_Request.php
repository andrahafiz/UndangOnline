            ...
            <div class="page-wrapper">
                <div class="page-body">
                    ...
                    <?php } else { ?>
                        ...
                        <?php if ($status_tarik->Status_Req == 2) { ?>
                                        ...
                                        <div class="row m-l-0 m-r-0">
                                            <div class="col-sm-4 bg-c-pink user-profile">
                                                <div class="card-block text-center text-white">
                                                    ...
                                                    <em>Username</em>
                                                    <h2 class="f-w-600"><?= $this->session->userdata('Username') ?></h2>
                                                    <a href="<?= base_url('Mempelai/TarikHadiah/cetak'); ?>">
                                                        <button class="btn btn-success m-t-10"><i class="fa fa-print"></i>Cetak Bukti</button>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-sm-8">
