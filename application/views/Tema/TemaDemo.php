                            ...
                            <div class="col-md-10 col-md-offset-1">
                                <div class="col-md-6 col-sm-6 text-center">
                                    <div class="event-wrap animate-box">
                                        ...
                                        <p><strong>Mutiara Palace</strong><br>Jl. Ahmad Yani</p>
                                        <p></p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 text-center">
                                    <div class="event-wrap animate-box">
                                        ...
                                        <p><strong>Monas</strong><br>Jl. Gatot</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="owl-carousel-fullwidth">
                                    <div class="item">
                                        <div class="testimony-slide active text-center">
                                            <span>Rahmad Triadi</span>
                                            <blockquote>
                                                <p>"Selamat sudah jadi pasangan yang serasi! Semoga perjalanan kalian besama-sama membangun keluarga selalu tetap indah. Selamat menempuh kehidupan yang baru."</p>
                                            </blockquote>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="testimony-slide active text-center">
                                            <span>Cinta Laura</span>
                                            <blockquote>
                                                <p>"Happy wedding! Sudah enggak ada lagi galau meratapi status jomblo, ya? Berbahagialah selalu, dan semoga segera diberkahi dengan momongan."</p>
                                            </blockquote>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="testimony-slide active text-center">
                                            <h2>Pevita Pearce</h2>
                                            <blockquote>
                                                <p>"Alhamdulillah, selamat atas ikatan pernikahan kalian. Semoga pernikahan kalian senantiasa dilimpahi berkah, cinta, kebaikan, dan kebahagiaan. Jazakallahu khairan khatsira."</p>
                                            </blockquote>
                                        </div>
                                    </div>
                                </div>
