...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets\Admin\icon\font-awesome\css\font-awesome.min.css">
    <!-- Data Table Css -->
    ...
    <!-- <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets\Admin\assets\pages\data-table\extensions\buttons\css\buttons.dataTables.min.css"> -->
    <!-- jpro forms css -->
