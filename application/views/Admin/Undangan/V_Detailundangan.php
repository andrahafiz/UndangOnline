                                    ...
                                    <div class="card-block ">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <input type="date" id="tgl_akad" name="tgl_akad" class="form-control form-control-round m-b-10" value='<?= $detail_data->TglAkad; ?>'>
                                            </div>
                                            <div class="col-sm-4">
                                                <p class="f-w-600 m-b-5">Waktu Mulai</p>
                                                <input type="time" id="ts_akad" name="ts_akad" class="form-control form-control-round m-b-10" value="<?= $detail_data->WaktuMulaiAkad; ?>">
                                            </div>
                                            <div class=" col-sm-4">
                                                <p class="f-w-600 m-b-5">Waktu Berakhir</p>
                                                <input type="time" id="tf_akad" name="tf_akad" class="form-control form-control-round m-b-10" value="<?= $detail_data->WaktuSelesaiAkad; ?>">
                                            </div>
                                        </div>
                                ...
                                <div class="card ">
                                    ...
                                    <div class="card-block ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <p class="f-w-600 m-b-5">Tanggal</p>
                                                <input type="date" id="tgl_resepsi" name="tgl_resepsi" class="form-control form-control-round m-b-10" value="<?= $detail_data->TglResepsi; ?>">
                                            </div>
                                            <div class="col-sm-4">
                                                <p class="f-w-600 m-b-5">Waktu Mulai</p>
                                                <input type="time" id="ts_resepsi" name="ts_resepsi" class="form-control form-control-round m-b-10" value="<?= $detail_data->WaktuMulaiResepsi; ?>">
                                            </div>
                                            <div class="col-sm-4">
                                                <p class="f-w-600 m-b-5">Waktu Berakhir</p>
                                                <input type="time" id="tf_resepsi" name="tf_resepsi" class="form-control form-control-round m-b-10" value="<?= $detail_data->WaktuSelesaiResepsi; ?>">
                                            </div>
                                        </div>
                                        <p class="f-w-600 m-b-5">Tempat</p>
