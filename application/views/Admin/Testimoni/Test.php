...
<head>
    ...
    <!-- feather Awesome -->
    <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets\Admin\icon\feather\css\feather.css">
    <!-- Data Table Css -->
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets\Admin\pages\data-table\css\buttons.dataTables.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets\Admin\pages\data-table\extensions\buttons\css\buttons.dataTables.min.css">
    <!-- Style.css -->
                            ...
                            <li class="header-notification">
                                <div class="dropdown-primary dropdown">
                                    ...
                                    <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="d-flex align-self-center img-radius" src="<?= base_url(); ?>assets\Admin\images\avatar-4.jpg" alt="Generic placeholder image">
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="d-flex align-self-center img-radius" src="<?= base_url(); ?>assets\Admin\images\avatar-3.jpg" alt="Generic placeholder image">
                                                <div class="media-body">
                            ...
                            <div class="main-friend-list">
                                <div class="media userlist-box" data-id="1" data-status="online" data-username="Josephin Doe" data-toggle="tooltip" data-placement="left" title="Josephin Doe">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius img-radius" src="<?= base_url(); ?>assets\Admin\images\avatar-3.jpg" alt="Generic placeholder image ">
                                ...
                                <div class="media userlist-box" data-id="2" data-status="online" data-username="Lary Doe" data-toggle="tooltip" data-placement="left" title="Lary Doe">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="<?= base_url(); ?>assets\Admin\images\avatar-2.jpg" alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box" data-id="3" data-status="online" data-username="Alice" data-toggle="tooltip" data-placement="left" title="Alice">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="<?= base_url(); ?>assets\Admin\images\avatar-4.jpg" alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box" data-id="4" data-status="online" data-username="Alia" data-toggle="tooltip" data-placement="left" title="Alia">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="<?= base_url(); ?>assets\Admin\images\avatar-3.jpg" alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
            ...
            <div class="showChat_inner">
                ...
                <div class="media chat-messages">
                    <a class="media-left photo-table" href="#!">
                        <img class="media-object img-radius img-radius m-t-5" src="<?= base_url(); ?>assets\Admin\images\avatar-3.jpg" alt="Generic placeholder image">
                    </a>
                ...
                <div class="media chat-messages">
                    ...
                    <div class="media-right photo-table">
                        <a href="#!">
                            <img class="media-object img-radius img-radius m-t-5" src="<?= base_url(); ?>assets\Admin\images\avatar-4.jpg" alt="Generic placeholder image">
                        </a>
                    </div>
                </div>
                    ...
                    <nav class="pcoded-navbar">
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="">
                                    <a href="<?= base_url(); ?>assets\Admin\extra-pages\landingpage\index.htm" target="_blank">
                                ...
                                <li class="pcoded-hasmenu ">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="pcoded-hasmenu ">
                                            ...
                                            <ul class="pcoded-submenu">
                                                <li class="">
                                                    <a href="<?= base_url(); ?>assets\Admin\extra-pages\email-templates\email-welcome.htm">
                                                        <span class="pcoded-mtext">Welcome Email</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="<?= base_url(); ?>assets\Admin\extra-pages\email-templates\email-password.htm">
                                                        <span class="pcoded-mtext">Reset Password</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="<?= base_url(); ?>assets\Admin\extra-pages\email-templates\email-newsletter.htm">
                                                        <span class="pcoded-mtext">Newsletter Email</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="<?= base_url(); ?>assets\Admin\extra-pages\email-templates\email-launch.htm">
                                                        <span class="pcoded-mtext">App Launch</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="<?= base_url(); ?>assets\Admin\extra-pages\email-templates\email-activation.htm">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">Data Table
                                                                Extensions</a>
                                                        </li>
...
<![endif]-->
    ...
    <script type="text/javascript" src="<?= base_url(); ?>assets\Admin\bower_components\i18next-xhr-backend\js\i18nextXHRBackend.min.js">
    </script>
    <script type="text/javascript" src="<?= base_url(); ?>assets\Admin\bower_components\i18next-browser-languagedetector\js\i18nextBrowserLanguageDetector.min.js">
    </script>
