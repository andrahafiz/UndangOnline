                            ...
                            <div class="card bg-c-yellow update-card">
                                <div class="card-block">
                                    <div class="row align-items-end">
                                        <div class="col-8">
                                            <h4 class="text-white"> $45.000.000</h4>
                                            <h6 class="text-white m-b-0">Total Pemasukan</h6>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-c-green update-card">
                                <div class="card-block">
                                    <div class="row align-items-end">
                                        <div class="col-8">
                                            <h4 class="text-white"><?php echo $jumlah_akun ?></h4>
                                            <h6 class="text-white m-b-0">Jumlah Pengguna</h6>
                                        </div>
                                        <div class="col-4 text-right">
                                ...
                                <div class="card-block">
                                    <div class="row align-items-end">
                                        <div class="col-8">
                                            ...
                                            <h6 class="text-white m-b-0">Total Transaksi Pembayaran </h6>
                                        </div>
                                        <div class="col-4 text-right">
